...
Moreover, the individual diffusion coefficients for components in binary mixtures  often reveal significant deviations from symmetric Maxwell-Stefan or Fick diffusion coefficients, such that the introduction of effective diffusion cefficients, even in non-porous environments, becomes obligatory \cite{taylor93a}.  In agreement with our limited knowledge in terms of multicomponent solutions, even the molecular mechanisms enforcing the occurrence of effective diffusion coefficients in binary mixtures are yet unknown \cite{taylor93a}. \\
