...
logger = MLFlowLogger(
    ...
    save_dir="/work/stovey/ResNext-Models/ResNext101_64x4d-scratch/mlruns/"
)

checkpoint_callback = ModelCheckpoint(
    monitor="ptl/validation_accuracy",
    dirpath="/work/stovey/ResNext-Models/ResNext101_64x4d-scratch/ckpts/",
...
trainer = L.Trainer(
    ...
    default_root_dir="/work/stovey/ResNext-Models/ResNext101_64x4d-scratch/mlruns/",
...
trainer.fit(
    lit_model, 
    datamodule=datamodule, 
    ckpt_path="/work/stovey/ResNext-Models/ResNext101_64x4d-scratch/ckpts/ResNext101_64x4d-pretrained-epoch=81-ptl/validation_loss=1.48.ckpt"
)
