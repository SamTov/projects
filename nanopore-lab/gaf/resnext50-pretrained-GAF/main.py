...
logger = pl.loggers.MLFlowLogger(
    experiment_name=f"resnext50_32x4d-pretrained-{image_size}", 
    save_dir=f"/work/stovey/resnext/resnext50_32x4d-pretrained-{image_size}/mlruns/"
)

# Checkpointing for training state.
checkpoint_callback = pl.callbacks.ModelCheckpoint(
    monitor="ptl/validation_accuracy",
    dirpath=f"/work/stovey/resnext/resnext50_32x4d-pretrained-{image_size}/ckpts/",
    filename="resnext50_32x4d-pretrained-{epoch:02d}-{ptl/validation_loss:.2f}",
    save_top_k=2,
    mode="max",
)
...
trainer = pl.Trainer(
    ...
    logger=logger,
    num_nodes=2,
    accumulate_grad_batches=500,
    callbacks=[StochasticWeightAveraging(swa_lrs=1e-2), checkpoint_callback],
    devices=-1,
    strategy="ddp",
    max_epochs=hyperparameters["max_epochs"],
    log_every_n_steps=10,
    default_root_dir=f"/work/stovey/resnext/resnext50_32x4d-pretrained-{image_size}/mlruns/",
...
# ckpts = glob.glob(f"/work/stovey/resnext/resnext50_32x4d-pretrained-{image_size}/ckpts/*")
