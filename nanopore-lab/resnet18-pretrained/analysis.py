...
ckpt = torch.load(
    "/work/stovey/resnext/resnet18-pretrained-244/ckpts/resnet18-pretrained-epoch=169-ptl/validation_loss=0.92.ckpt"
)
...
# cm_metric = MulticlassConfusionMatrix(num_classes=42)
# micro_acc = torchmetrics.Accuracy(num_classes=42, average='micro', task="multiclass")
# macro_acc = torchmetrics.Accuracy(num_classes=42, average='macro', task="multiclass")

# print(micro_acc(predictions, targets))
# print(macro_acc(predictions, targets))
