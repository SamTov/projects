...
logger = pl.loggers.MLFlowLogger(
    experiment_name=f"resnet18-{image_size}", 
    save_dir=f"/work/stovey/resnext/resnet18-{image_size}/mlruns/"
)

# Checkpointing for training state.
checkpoint_callback = pl.callbacks.ModelCheckpoint(
    monitor="ptl/validation_accuracy",
    dirpath=f"/work/stovey/resnext/resnet18-{image_size}/ckpts/",
...
trainer = pl.Trainer(
    ...
    default_root_dir=f"/work/stovey/resnext/resnet18-{image_size}/mlruns/",
...
# ckpts = glob.glob(f"/work/stovey/resnext/resnet18-{image_size}/ckpts/*")
