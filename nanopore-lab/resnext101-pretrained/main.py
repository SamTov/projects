...
logger = pl.loggers.MLFlowLogger(
    ...
    save_dir=f"/work/stovey/resnext/resnext101-pretrained-{image_size}/mlruns/"
)

# Checkpointing for training state.
checkpoint_callback = pl.callbacks.ModelCheckpoint(
    monitor="ptl/validation_accuracy",
    dirpath=f"/work/stovey/resnext/resnext101-pretrained-{image_size}/ckpts/",
...
trainer = pl.Trainer(
    ...
    default_root_dir=f"/work/stovey/resnext/resnext101-pretrained-{image_size}/mlruns/",
