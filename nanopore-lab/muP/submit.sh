...
python main.py --arch resnet18 --save_base_shapes resnet18.bsh --width_mult 1
python main.py --arch resnet18 --width_mult 2 --optimizer muadam --load_base_shape resnet18.bsh --batch_size 24 --accumulate_batches 500 --num_workers 8
